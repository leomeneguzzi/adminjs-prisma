...
export declare const safeParseNumber: (value?: string | number | boolean | Record<string, any> | null | undefined) => string | number | null | boolean | Record<string, any> | undefined;
